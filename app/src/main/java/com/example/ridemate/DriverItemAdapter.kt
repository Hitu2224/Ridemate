...
class DriverItemAdapter(private val context: Context, private val rideList:List<Data>):RecyclerView.Adapter<DriverItemAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val settime:TextView=itemView.findViewById(R.id.time)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view=LayoutInflater.from(parent.context).inflate(R.layout.driver_ride_item,parent,
            false)
